...
fighter_t character_get(renderer_t *renderer, character_name_t name, float hue)
{
    ...
    if (hue > 0.0f)
    {
        ...
        fg.texture = asset_get_texture(fg.stat.default_asset);

    // Point the runtime fighter at its definition
    fg.hp             = fg.stat.base_hp;
...
static const fighter_t fajter_characters[CHARACTER_COUNT] =
{
    [CHARACTER_BOKE] =
    {
        ...
        .stat = {
            ...
            .animations[ANIM_IDLE] = ANIM(true, TICKS(3 * 15),
            ...
            .animations[ANIM_STAND_BLOCK] = ANIM(false, TICKS(15),
                FRAME_HURT(TILE_48x96(3), TICKS(15), 24, 88,  12, 12, 24, 72)
            ),
                
            .animations[ANIM_CROUCH] = ANIM(false, TICKS(4 * 5), 
            ...
            .animations[ANIM_CROUCH_BLOCK] = ANIM(false, TICKS(15),
                FRAME_HURT(TILE_48x96(8), TICKS(15), 24, 88,  8, 48, 36, 36)
            ),

            .animations[ANIM_STAND_HITSTUN] = ANIM(false, TICKS(15),
                FRAME_HURT(TILE_48x96(9), TICKS(15), 24, 88,  12, 12, 24, 72)
            ),

            .animations[ANIM_CROUCH_HITSTUN] = ANIM(false, TICKS(15), 
                FRAME_HURT(TILE_48x96(10), TICKS(15), 24, 88,  8, 48, 36, 36)
            ),

            .animations[ANIM_WALK_BACKWARD] = ANIM(true, TICKS(3 * 15),
            ...
            .animations[ANIM_WALK_FORWARD] = ANIM(true, TICKS(3 * 15),
            ...
            .animations[ANIM_AIRBORNE] = ANIM(false, TICKS(15 + 5 + 5),
            ...
            .animations[ANIM_AIRBORNE_HITSTUN] = ANIM(false, TICKS(15),
                FRAME_HURT(TILE_48x96(20), TICKS(15), 24, 88,  8, 40, 36, 44)
            ),
                
            // ---- SIZE 64x96 ---------------------------------------------------
            .animations[ANIM_STAND_LIGHT] = ANIM(false, TICKS(5 + 3 + 5),
                FRAME_HURT(TILE_64x96(0), TICKS(5), 24, 88,  24, 12, 24, 72),
            ...
            {
                .damage = 10,
                .stun_duration = TICKS(9),
                .knockback_x   = 10.0f,
                .recoil_x      = 100.0f, 
                
                .startup_ticks = TICKS(5),
                .active_ticks = TICKS(3),

                .triger = ATK_TRIGGER_ON_HIT,
                .flags  = ATK_FLAG_CANCEABLE
            }, 
            
            .animations[ANIM_CROUCH_LIGHT] = ANIM(false, TICKS(5 + 3 + 4), 
                FRAME_HURT(TILE_64x96(2), TICKS(5), 16, 88,  8, 48, 36, 36),
            ...
            .animations[ANIM_STAND_HEAVY] = ANIM(false, TICKS(5 * 5),
            ...
            .animations[ANIM_CROUCH_HEAVY] = ANIM(false, TICKS((4 * 5) + 10),
            ...
            .animations[ANIM_AIRBORNE_ATK] = ANIM(false, TICKS(20 + 15),
            ...
            .attacks[ATK_ID_AIRBORNE_ATK] = 
            {
                ...
                .startup_ticks = TICKS(20),
                .active_ticks = TICKS(15),
            ...
            // ---- 2. ROW -----------------------------------------------------
            .animations[ANIM_KNOCKDOWN] = ANIM(false, TICKS(4 * 10),
            ...
            .animations[ANIM_RECOVERY] = ANIM(false, TICKS(3 * 9), 
            ...
            .animations[ANIM_DASH_BACKWARD] = ANIM(false, TICKS(2 * 9), 
                FRAME_HURT(TILE_48x96(11), TICKS(9), 32, 88,  8, 16, 24, 68),
                FRAME_HURT(TILE_48x96(12), TICKS(9), 32, 88,  8, 16, 24, 68),
            ),

            .animations[ANIM_DASH_FORWARD] = ANIM(false, TICKS(2 * 9),
                FRAME_HURT(TILE_64x96(20), TICKS(9), 24, 88,  0, 24, 6*8, 8*7),
                FRAME_HURT(TILE_64x96(21), TICKS(9), 24, 88,  0, 24, 6*8, 8*7),
            ),

            // ---- COMBOS ---------------------------------------------
            .animations[ANIM_COMBO1] = ANIM(false, TICKS(5 + 5 + 7 + 10),
            ...
            .animations[ANIM_COMBO2] = ANIM(false, TICKS(15 + (6 * 8) + 30),
